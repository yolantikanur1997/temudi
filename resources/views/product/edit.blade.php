                     ...
                     <form action="{{ url('product/'.$product->id.'') }}" method="POST" id="form-add">
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-sm-12 mb-3">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-9">
                                                    <input type="text" class="form-control required" data-required="Nama" name="name" id="name" value="{{ $product?->name?? '' }}">
                                                </div>
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-sm-12 mb-3">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-9">
                                                    <input type="text" class="form-control required price-format required" data-required="Price" name="price" id="price" value="{{ $product?->price ? number_format($product->price, 0, ',', '.') : '' }}">
                                                </div>
                                            </div>
                                ...
                                <div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-9">
                                                    <textarea class="form-control" name="notes" id="notes" rows="3" placeholder="Catatan"> {{$product?->notes}} </textarea>
                                                </div>
                                            </div>
